  ...
  return (
    <div className="max-w-7xl mx-auto mb-32">
      ...
      <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 my-10">
        <div className="card bg-base-100 shadow-xl mx-3">
          ...
          <div className="card-body items-center text-center">
            <h2 className="card-title text-2xl">Team Member 01</h2>
        ...
        <div className="card bg-base-100 shadow-xl mx-3">
          ...
          <div className="card-body items-center text-center">
            <h2 className="card-title text-2xl">Team Member 02</h2>
            <h2 className="text-xl font-semibold text-[#737373]">
              Service Expert
            </h2>
          </div>
        ...
        <div className="card bg-base-100 shadow-xl mx-3">
          ...
          <div className="card-body items-center text-center">
            <h2 className="card-title text-2xl">Team Member 03</h2>
            <h2 className="text-xl font-semibold text-[#737373]">
              Store Expert
            </h2>
          </div>
