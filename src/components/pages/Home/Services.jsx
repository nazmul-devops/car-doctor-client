...
const Services = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 my-10">
        {services &&
          services?.map(service => (
            <div key={service.id} className="card bg-base-100 shadow-xl mx-3">
              <figure className="px-10 pt-10">
                <img
                  src={service.img}
                  alt="Shoes"
                  className="rounded-xl w-[314px] h-[208px]"
                />
              </figure>
              <div className="p-10 gap-2 items-center space-y-5">
      ...
      <div className="flex flex-col p-5 mx-3 space-y-5 bg-[#151515] my-32 rounded-xl text-white  md:h-64 md:flex-row lg:flex-row justify-around items-center">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="pb-3">We are open monday-friday</p>
            <h3 className="text-xl md:text-2xl font-bold">7:00 am - 9:00 pm</h3>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="pb-3">Have a question?</p>
            <h3 className="text-xl md:text-2xl font-bold">+2546 251 2658</h3>
          </div>
        </div>
